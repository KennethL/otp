...
-export([encode_boolean/2,decode_boolean/2,
	 ...
	 decode_integer/1,
	 number2name/2,
	 encode_unnamed_bit_string/1,encode_unnamed_bit_string/2,
	 encode_named_bit_string/2,encode_named_bit_string/3,
	 encode_bit_string/4,
	 decode_named_bit_string/2,
	 decode_compact_bit_string/2,compact_bit_string_size/1,
	 decode_native_bit_string/1,
	 ...
	 encode_restricted_string/1,
	 decode_octet_string/1,
	 decode_restricted_string/1,
...
encode_unnamed_bit_string(Bits) ->
    Unused = (8 - (bit_size(Bits) band 7)) band 7,
    Bin = <<Unused,Bits/bitstring,0:Unused>>,
    Bin.

encode_unnamed_bit_string(MaxBits, Bits) ->
...
encode_named_bit_string([H|_]=Bits, NamedBitList) when is_atom(H) ->
    do_encode_named_bit_string(Bits, NamedBitList);
encode_named_bit_string([{bit,_}|_]=Bits, NamedBitList) ->
    do_encode_named_bit_string(Bits, NamedBitList);
encode_named_bit_string([], _NamedBitList) ->
    encode_unnamed_bit_string(<<>>);
encode_named_bit_string(Bits, _NamedBitList) when is_bitstring(Bits) ->
    encode_unnamed_bit_string(Bits).

encode_named_bit_string(C, [H|_]=Bits, NamedBitList) when is_atom(H) ->
    do_encode_named_bit_string(C, Bits, NamedBitList);
encode_named_bit_string(C, [{bit,_}|_]=Bits, NamedBitList) ->
    do_encode_named_bit_string(C, Bits, NamedBitList);
encode_named_bit_string(C, [], _NamedBitList) ->
    encode_unnamed_bit_string(C, <<>>);
encode_named_bit_string(C, Bits, _NamedBitList) when is_bitstring(Bits) ->
    encode_unnamed_bit_string(C, Bits).

do_encode_named_bit_string([FirstVal | RestVal], NamedBitList) ->
    ToSetPos = get_all_bitposes([FirstVal | RestVal], NamedBitList, []),
    Size = lists:max(ToSetPos) + 1,
    BitList = make_and_set_list(Size, ToSetPos, 0),
    encode_bitstring(BitList).

do_encode_named_bit_string(Size, [FirstVal | RestVal], NamedBitList) ->
    ToSetPos = get_all_bitposes([FirstVal | RestVal], NamedBitList, []),
    BitList = make_and_set_list(Size, ToSetPos, 0),
    {_Len, _Unused, _OctetList} = encode_bitstring(BitList).
...
decode_native_bit_string(Buffer) ->
    case Buffer of
	<<>> ->
	    <<>>;
	<<Unused,Bits/binary>> ->
...
decode_named_bit_string(Buffer, NamedNumberList) ->
    case Buffer of
	<<>> ->
	    [];
	<<Unused,Bits/binary>> ->
...
%%============================================================================
encode_restricted_string(OctetList)  when is_binary(OctetList) ->
    OctetList;
encode_restricted_string(OctetList) when is_list(OctetList) ->
    list_to_binary(OctetList).

%%============================================================================
%% decode OCTET STRING to binary
%%============================================================================

decode_octet_string(Bin) ->
    binary:copy(Bin).
